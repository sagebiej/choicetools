...
The package contains some files that may make your life as a choice modeller easier, especially if you use the r package `apollo`.
...
-   quicktexregapollo: If you want to create publication-ready tables with texreg, this function transforms an apollo object into a texreg object
